...
class year_created extends year_base {
    /**
     * @override \local_cpd\base_event
     */
    public static function get_name() {
        return util::string('event:yearcreated');
    }
    ...
    public function get_description() {
        return util::string('event:yearcreateddesc',
    ...
    public function get_legacy_logdata() {
        return array_merge(parent::get_legacy_logdata(), array(
            static::LEGACY_LOGDATA_ACTION => 'cpd year create',
        ));
    }
