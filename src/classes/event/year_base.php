...
abstract class year_base extends base_event {
     ...
     *
     * @param \local_cpd\model\year $year The affected CPD year.
     *
     * @return \local_cpd\event\year_base The event.
     */
    final public static function instance($year) {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = year::model_table();
    }
}
